...
class GNNReGVD(nn.Module):
    ...
    def forward(self, input_ids=None, labels=None, logit_adjustment=None, focal_loss=False):
        # construct graph
...
class DevignModel(nn.Module):
    def __init__(self, encoder, config, tokenizer, args):
        ...
        self.gnn = GGGNN(feature_dim_size=args.feature_dim_size, hidden_size=args.hidden_size,
                         num_GNN_layers=args.num_GNN_layers, dropout=config.hidden_dropout_prob)
